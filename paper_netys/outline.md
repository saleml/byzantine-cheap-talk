...
- Cheap talk (pre-play communication) dramatically improves cooperation in Stag Hunt (prior EACL result: 0% to 48.3%)
...
- k=1: Qwen 7/7 never switched, Llama 8/9 never switched; Mixtral 0/8, DeepSeek 0/6 all permanently switched
...
### 4.5 Communication Topology (Explicit)
